      ...
      <Wrapper open={isOn} shouldAnimate={shouldAnimate}>
        ...
        <Body className='midwrpr' open={isOn} shouldAnimate={shouldAnimate}>
          <div className='conPage'>
              ...
              <Page className='mainBtn' variant="register" onClick={() => setLinkHandler("register")}>
                  <LinkTag>Register</LinkTag>
              </Page>
              <Page className='mainBtn' variant="login" onClick={() => setModalShow(true)}>
